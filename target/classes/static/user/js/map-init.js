		...
		marker[i]= new google.maps.Marker(
				{
					position : new google.maps.LatLng(locations[i][1],
							locations[i][2]),
					map : map,
					icon : "/user/images/airplane-mode-on-symbol.png"
				});
		var content = "<p id='location-" + i + "'>" + locations[i][0] + "</p>"
		infowindow.setContent(content);
		google.maps.event.addListener(marker[i], 'click', (function(m, content,infowindow) {
			return function() {
				infowindow.setContent(content);
